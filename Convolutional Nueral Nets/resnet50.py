...
#when the input size is not equal to the output size then there is requirement of conv layer in the shortcut so that the matriX dimensions can be matched
